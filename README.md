...
- **Skill breakdown** — click any player to see which skills deal the most damage, with icons and a damage timeline chart
...
A: The meter reads network packets passively — it does not modify game memory or inject any code. It is similar in principle to tools like ACT used in other MMOs. Use at your own discretion.

**Q: The overlay is empty / showing no data.**  
A: Make sure Aion 2 is running on the same PC. Enter a combat zone — data appears as soon as skills are used.
...
- Website: [aion2t.com](https://aion2t.com)
- Bugs & suggestions: [GitHub Issues](https://github.com/Grachy/aion2t-dps-meter/issues)

---

<div align="center">
  <sub>Made with ❤️ by <a href="https://aion2t.com">aion2t.com</a></sub>
</div>
