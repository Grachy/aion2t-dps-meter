<div align="center">
  ...
  [![Version](https://img.shields.io/badge/version-1.1.18-blue)](#download)
  ...
  [**⬇ Download v1.1.18**](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe) · [Website](https://aion2t.com/dps-meter) · [Report a Bug](https://github.com/Grachy/aion2t-dps-meter/issues)
...
**[⬇ Download aion2t-dps-setup-1.1.18-x64.exe](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
- **Reliable fight uploads** — upload retries with backend + frontend (WebView2) fallback, background re-attempts at 1/2/5 min, and automatic retry of failed uploads on next app launch. Upload status badges (✓ / !) in fight history
- **Combat Power (CP) detection** — CP is now extracted from party roster packets (0297), LiveStatus broadcasts, and gear-score scan (0x3692); displayed per player alongside GS
- **Improved LiveStatus parser** — rewritten with server-anchored name scanning that works reliably for both KR and TW regions; now extracts CP, GS, and class from status packets
- **Compact roster support** — new parser for the compact 0297 party roster variant (variable-length fields); extracts names, class, and CP via AF 0F 04 marker fallback
- **Smarter self-proxy merge** — deferred proxy adoption waits for class confirmation from the 0297 roster before merging, preventing wrong-class party members from being mistakenly merged as the owner's combat entity; wrong merges are auto-undone when SPAWN44 arrives
- **Accurate class detection** — skill-based class detection now takes priority over roster jobCode (which can be stale from compressed-data false matches)
- **Fixed DOT attribution** — removed `owner_hint` redirect for DOT packets (matching behavior of Flow/fundps/Kuroukihime/Abyss); orphan merge handles unnamed phantoms post-hoc
- **Fixed player death counting** — both 0x3641 and 0x8D21 packets now count player deaths (TW only sends 0x8D21 for players); boss-mechanic dead→alive flickers are cancelled
- **Entity tracking stability** — `known_player_ids` is no longer cleared between fights, preventing DOT mis-attribution when the same player re-appears after a flush
- **GS reading fix** — owner's Gear Score now correctly read as u16 (was u32), confirmed from raw packet analysis
- **CP/GS cache management** — entity-keyed stats are cleared on zone change while name-keyed caches are preserved across fights for continuity
...
**[⬇ Скачать v1.1.18](https://disk.yandex.com/d/ZTZDbNMDDAsTKQ)**
...
**[⬇ Download v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ Télécharger v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ Descargar v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ Baixar v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ ダウンロード v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ 다운로드 v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ 下载 v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
...
**[⬇ 下載 v1.1.18](https://raw.githubusercontent.com/Grachy/aion2t-dps-meter/master/docs/aion2t-dps-setup-1.1.18-x64.exe)**
